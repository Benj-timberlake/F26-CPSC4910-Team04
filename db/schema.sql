...
-- audit log of password changes: who, when, and whether it was a normal change or a reset
...
-- forgot-password links. only a hash of the token is stored, each one is single use and expires
